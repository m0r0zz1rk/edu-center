'''Usage : python celery_beat.py install (start / stop / remove)
...
PYTHONSCRIPTPATH = 'C:\\inetpub\\sites\\edu-dev.coko38.ru\\venv\\Scripts'
...
class CeleryService(win32serviceutil.ServiceFramework):
    ...
    _svc_display_name_ = "Celery Scheduled Tasks"
    ...
    def SvcDoRun(self):
        ...
        command = '"{celery_path}" -A {proj_dir} beat -l info --pidfile='.format(
